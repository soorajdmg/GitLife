  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#f9fafb', minHeight: '100dvh', overflowX: 'hidden', color: 'oklch(14% 0.015 260)' }}>
      ...
      <footer style={{ padding: 'clamp(24px, 3vw, 40px) clamp(20px, 4vw, 56px)', borderTop: '1px solid oklch(93% 0.006 80)' }}>
        <div className="gl-container" style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
          {/* Top row: branding | nav | GitHub */}
          <div className="gl-footer-inner" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
            {/* Left: logo + made by stacked */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <Logo size={22} />
                <span style={{ fontSize: 13.5, fontWeight: 800, color: 'oklch(18% 0.015 260)', letterSpacing: '-0.022em' }}>GitLife</span>
              </div>
              <p style={{ fontSize: 11.5, color: 'oklch(66% 0.01 260)', margin: 0, paddingLeft: 1 }}>
                Made by{' '}
                <a
                  href="https://soorajmurugaraj.vercel.app"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: 'oklch(50% 0.12 260)', fontWeight: 600, textDecoration: 'none' }}
            ...
            {/* Right: copyright + GitHub button */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 10 }}>
              <a
                href="https://github.com/soorajdmg/GitLife"
                target="_blank"
                rel="noopener noreferrer"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '8px 16px', borderRadius: 8, border: '1.5px solid oklch(88% 0.008 260)', background: 'oklch(98% 0.004 260)', color: 'oklch(22% 0.015 260)', fontSize: 13, fontWeight: 600, textDecoration: 'none', transition: 'all 0.2s' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'oklch(94% 0.008 260)'; e.currentTarget.style.borderColor = 'oklch(70% 0.01 260)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = 'oklch(98% 0.004 260)'; e.currentTarget.style.borderColor = 'oklch(88% 0.008 260)'; }}
              >
                ...
                Star on GitHub
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ opacity: 0.5 }}>
